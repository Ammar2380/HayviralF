...
import video1 from "./Hero Section/hero 1.mp4";
import video2 from "./Hero Section/hero 2.mp4";
import video3 from "./Hero Section/hero 3.mp4";
      ...
      <div className="relative w-full max-w-[1224px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <div className="mt-6 flex flex-col gap-6 items-center md:items-start">
            ...
            <div className="flex flex-col gap-6 items-center md:items-start">
              <div className="overflow-hidden w-90 mb-5 md:w-120">
                <motion.div
        ...
        >
          <div className="flex gap-4 justify-center md:justify-end mb-6">
            <VideoCard videoSrc={video1} rotate="-rotate-5" />
            <VideoCard videoSrc={video3} rotate="-rotate-1" />
            <div className="hidden md:block">
              <VideoCard videoSrc={video2} rotate="rotate-5" />
            </div>
          </div>
        </motion.div>
      </div>
